...
<div class="xFUwe" data-track-load="description_content"><p>You have a <code>RecentCounter</code> class which counts the number of recent requests within a certain time frame.</p>
...
class NumberOfRecentCalls {
	...
	public int ping(int t) {
		counter.add(t);
		while (counter.peek() != null && counter.peek() < t - 3000) {
			counter.poll();
		}
		return counter.size();
	}
